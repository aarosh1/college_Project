...
<div id="carouselId" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="carousel-item active" style="height: 42em">
				<img src="img/oly.jpg" alt="First slide" class="w-100 h-100">
				<div class="carousel-caption d-none d-md-block">
				
				</div>
			</div>
			<div class="carousel-item" style="height: 42em">
				<img src="img/pic3.jpg" alt="Second slide" class="w-100 h-100">
				<div class="carousel-caption d-none d-md-block">
					
				</div>
			</div>
			<div class="carousel-item" style="height: 42em">
				<img src="img/pic4.jpg" alt="Third slide" class="w-100 h-100">
				<div class="carousel-caption d-none d-md-block">
...
<p><a href="mailto:info@domain.com" title="glorythemes">poudelaakash23@gmail.com</a></p>
