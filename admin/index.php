    ...
    <div id="content">
      ...
      <div class="container" style="padding:40px">
        <div class="row">
          ...
          <div class="col-md-6">
            <h2 class="display-4">Log in to Admin Dashboard</h2>
            <form action="" method="post">
              ...
              <a href="reset-password.php" class="btn btn-danger btn-lg btn-block" style="margin:10px 0px">Forgot Password?</a>

              <a href="signup.php" class="btn btn-primary btn-lg btn-block" style="margin:10px 0px">Create New Account / Signup</a>
