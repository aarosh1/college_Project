...
<body>
  ...
  <nav class="navbar bg-secondary navbar-expand-lg ">
    ...
    <div class="container-fluid">
      ...
      <a class="btn btn-primary" href="user-login.php"> User Login</a> &nbsp;
  ...
  <div class="container" style="padding:40px">
    <div class="row">
      ...
      <div class="col-md-6">
        <h2 class="display-4 text-center">Log In To User</h2>
        <form action="" method="post">
          ...
          <a href="user-signup.php" class="btn-success text-center btn-lg btn-block" style="margin:10px 0px">Create New Account</a> <br>
          <a href="reset-password.php" class="btn-success text-center btn-lg btn-block" style="">Forgot Password?</a>
        </form>
        <?php
