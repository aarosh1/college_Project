...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="video-gallery.php">Live Broadcast</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center text-white p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg"><span class="font-weight-bold text-white">Roshan Poudel</span><span class="text-black-50">roshan@gmail.com</span><span> </span></div>
        </div>
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col-md-6"><label class="labels">Name</label><input type="text" class="form-control" placeholder="first name" value="Roshan"></div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-12"><label class="labels">Email ID</label><input type="text" class="form-control" placeholder="enter email id" value="roshan@gmail.com"></div>
                    </div>
    ...
    <footer id="footer" class="footer-1">
        <div class="main-footer  bg-secondary widgets-dark typo-light">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="widget no-box">
                            ...
                            <ul class="thumbnail-widget">
                                ...
                                <li>
                                    <div class="thumb-content"><a href="photo-gallery.php">Gallery</a></div>
                                </li>
                                <li>
                                    <div class="thumb-content"><a href="video-gallery.php">Broadcast</a></div>
                                </li>
                                <li>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="widget no-box">
                            ...
                            <a class="btn" href="user-signup.php" target="_blank">Sign Up Now</a>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        ...
                        <div class="widget no-box">
                            ...
                            <p><a href="mailto:poudelaakash23@gmail.com" title="glorythemes">poudelaakash23@gmail.com</a></p>
        ...
        <div class="footer-copyright bg-secondary text-dark">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center text-dark">
                        <p class="text-white">Copyright FunOlympics © 2023. All rights reserved.</p>
                        <br>
                        <p class="text-white">Designed By Roshan Poudel.</p>
                    </div>
                </div>
            </div>
        </div>
